...
const HeaderDetail = () => {
    return(
        // <!-- header start -->
        <header className="bg-[#00c2cb] top-0 left-0 w-full flex items-center z-10 border-b border-slate-400">
            <div className="container mx-auto p-2 pb-2">
                <div className="flex items-center">
                    <div className="w-1/12 pr-2 flex items-center justify-center">
                        <button>
                        ...
                        <div>
                            <div className="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="price" id="price"
                                    ...
                                    placeholder="Cari dekorasi pelaminan"/>
                            </div>
                        </div>
                    </div>
                    <div className="w-3/12">
                        <div className="flex items-center justify-between px-2">
                            ...
                            <Link to="#"><svg xmlns="http://www.w3.org/2000/svg" className="w-5 fill-white"
                                    viewBox="0 0 448 512">
                                    {/* <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
                                    <path
